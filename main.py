...
def parse_args():
    ...
    parser.add_argument('--image',dest = 'image',help='Image path', default='./training/image_2')
    parser.add_argument('--label',dest = 'label',help='Label path', default='./training/label_2')
    parser.add_argument('--box2d',dest = 'box2d',help='2D detection path', default='./training/label_2')
    parser.add_argument('--output',dest = 'output',help='Output path', default = './validation/result_2/')
    parser.add_argument('--model',dest = 'model', default='./model-50')
...
def test(model, image_dir, box2d_loc, box3d_loc):
    ...
    for f in all_image:
        ...
        box2d_file = os.path.join(box2d_loc, f.replace('png', 'txt'))
        box3d_file = os.path.join(box3d_loc, f.replace('png', 'txt'))
        print(image_file)
